...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        titoloLogin.setFont(new java.awt.Font("Segoe UI", 0, 36)); // NOI18N
        ...
        nomeUtente_label.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        ...
        reimpostaValori_button.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        recuperaCredenziali_button.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        if (email.length()>0 && password.length()>0){
            ...
            try{
                ...
                if(email.equals(rs.getString("email")) && password.equals(rs.getString("password")) && farmacista.equals(rs.getString("lavoro"))){
                    ...
                    farmacia.toFront();
                    farmacia.setTitle("Pharmalink - Sezione farmacista");
