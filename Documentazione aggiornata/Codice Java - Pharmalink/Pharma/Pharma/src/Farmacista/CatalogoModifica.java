...
public class CatalogoModifica {
    private String idOrdine, idFarmaco, nome, principio, scadenza, disponibili, dataConsegna, quantitaAttuale;
    public CatalogoModifica(String idOrdine, String idFarmaco, String nome, String principio, String scadenza, String disponibili, String dataConsegna, String quantitaAttuale){
        this.nome = nome;
